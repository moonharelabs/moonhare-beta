...
describe('utilities', () => {
    ...
    test('object-position with config', () => {
        expect(
            css(
                'object-cutom',
                new Processor({
    ...
    test('overscroll-behavior', () => {
        expect(
            css('overscroll-auto overscroll-contain overscroll-none')
        ).toMatchSnapshot();
        expect(
            css('overscroll-x-auto overscroll-x-contain overscroll-x-none')
        ).toMatchSnapshot();
        expect(
            css('overscroll-y-auto overscroll-y-contain overscroll-y-none')
        ).toMatchSnapshot();
    });
